...
public class SecondCustomAI extends PacmanController {
    ...
    public SecondCustomAI(int maxDepth, int treeLimit) {
...
class Node {
    ...
    private SecondCustomAI mctsPacMan;
    private Node parent;
    ...
    public Node(SecondCustomAI mctsPacMan, int index, MOVE moveToThisNode, PillModel pillModel) {
...
//            children = new Node[pacManLocation.possibleMoves().length];
    ...
    //    MOVE bestMOVE =  pacManLocation.possibleMoves()[bestAction];
        ...
        while (true) {
            ...
            if(ghostPenalty >= SecondCustomAI.DEATH_PENALTY) break;
        }
        ...
        children[bestAction].pillScore = childModel.getPillsFraction() * SecondCustomAI.PILL_GAIN;
//        System.out.println("Pill Score: " + children[bestAction].pillScore );
    ...
    public double rollout() {
        ...
        while (depth < mctsPacMan.getMaxDepth() - 1) {
            if (rolloutGhostPenalty >= SecondCustomAI.DEATH_PENALTY) break;
...
//        System.out.println(rolloutGhostPenalty + ": " + rolloutPillScore);
    ...
    public boolean isLeaf(){
        return (ghostPenalty >= SecondCustomAI.DEATH_PENALTY);
    }
